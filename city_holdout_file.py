...
if __name__ == '__main__':
    ...
    print("Holdout summary output")
    print("")

    holdout_count_df = holdout_checks(holdout_final_df, holdout_df)
    holdout_count_df.to_csv("holdout_counts.csv", index=False)


# holdout_checks = solve 