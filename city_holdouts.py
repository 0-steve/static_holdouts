...
if __name__ == '__main__':
    ...
    misc_df = pd.read_pickle("citiesHoldout_marketID_2022-04-26.pkl")
    holdout_df = pd.read_pickle("citiesHoldout_summary_2022-04-26.pkl")
    ...
    final_name = f"{name}_StaticHoldouts.csv"
    holdout_final_df.to_csv(final_name, index=False)
  
    summary_name = f"{name}_StaticHoldouts_Summary.csv"
